...
namespace R20.Forms
{
    public partial class FormVaraukset : Form
    {
        private static MySqlConnection connection = Sqlyhteys.connection();
        private static MySqlCommand cmd = null;
        public FormVaraukset()
        {
            InitializeComponent();
        }
        private void FormVaraukset_Load(object sender, EventArgs e)
        {
            try
            {
                connection.Open();
        ...
        private void btnTyhjennaVarausPalvelu_Click(object sender, EventArgs e)
        {
            tyhjennapalvelu();
        }
